...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = glm::mat4(1.0);
		//model = glm::translate(model, glm::vec3(1.0f, 5.18f, -1.5f));
		model = glm::translate(model, glm:: vec3(1.0f, 5.18f, mainWindow.getPosicionCarro()));
		...
		//Cofre-----------------------------------------------------------------
		color = glm::vec3(0.65f, 0.65f, 0.0f);
		model = glm::translate(model, glm::vec3(4.25f, 12.0f, -23.5f));
		...
		model = glm::translate(model, glm::vec3(32.0f, -10.0f, -44.0f));
		...
		model = modelcuerpo;
		color = glm::vec3(0.0f, 0.0f, 0.0f);
		model = glm::translate(model, glm::vec3(-26.0f, -10.0f, -44.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion2()), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion3()), glm::vec3(0.0f, 1.0f, 0.0f));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		model = modelcuerpo;
		color = glm::vec3(0.0f, 0.0f, 0.0f);
		model = glm::translate(model, glm::vec3(32.0f, -10.0f, 53.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion2()), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion3()), glm::vec3(0.0f, 1.0f, 0.0f));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		model = modelcuerpo;
		color = glm::vec3(0.0f, 0.0f, 0.0f);
		model = glm::translate(model, glm::vec3(-26.0f, -10.0f, 53.5f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion2()), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion3()), glm::vec3(0.0f, 1.0f, 0.0f));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
