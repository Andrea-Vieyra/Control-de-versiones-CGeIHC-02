...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		//meshList[3]->RenderMesh(); // Renderizar el cubo (cabina)
		//model = modelaux; //para descartar la escala que no quiero heredar se carga la información de la matriz auxiliar

		////LLANTAS
		//modelaux = model;
		////Articulacion llanta 1 (derecha frente)
		//model = glm::translate(model, glm::vec3(-2.25f, 3.23f, 0.0f));
		//model = glm::rotate(model, glm::radians(mainWindow.getarticulacion5()), glm::vec3(0.0f, 0.0f, 1.0f));
		//
		////Llanta 1 (derecha frente) 
		...
		////Articulacion llanta 2 (izquierda enfrente)
		//modelaux = model;
		//model = glm::translate(model, glm::vec3(-2.25f, 3.23f, -4.0f));
		//model = glm::rotate(model, glm::radians(mainWindow.getarticulacion6()), glm::vec3(0.0f, 0.0f, 1.0f));
		//
		////Llanta 2 (izquierda enfrente)
		//model = glm::translate(model, glm::vec3(0.0f, 0.0f, -0.13f));
		//model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		//model = glm::scale(model, glm::vec3(0.8f, 0.8f, 0.8f));
		//glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		////articulación 1
		//model = glm::translate(model, glm::vec3(0.0f, 6.0f, -4.0f));//Poniendo artoculación en la punta del brazo
		//model = glm::rotate(model, glm::radians(mainWindow.getarticulacion1()), glm::vec3(0.0f, 0.0f, 1.0f));//Indicamos que nuestro brazo se mueva en z
		//
		...
		//model = glm::scale(model, glm::vec3(2.5f, 0.5f, 2.5f));
		//glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		//meshList[0]->RenderMesh(); //dibuja cubo y pirámide triangulartraslacion
		...
		//MANCHA CENTRO CUERPO
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, 0.6f));
		modelaux = model;
		model = glm::rotate(model, glm::radians(-90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.8f, 1.0f, 1.7f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//PIERNA IZQUIERDA
		//Articulación 1---------------------------------------------
		model = glm::translate(model, glm::vec3(-0.7f, -1.8f, -0.5f));
		...
		model = glm::scale(model, glm::vec3(0.8f, 0.5f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//PIERNA DERECHA
		//Articulación 3---------------------------------------------
		model = glm::translate(model, glm::vec3(0.8f, 4.17f, -4.0f));
		...
		model = glm::translate(model, glm::vec3(0.0f, -0.35f, 0.1f));
		model = glm::scale(model, glm::vec3(0.8f, 0.5f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.7f, 0.7f, 0.7f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		...
		//BRAZO IZQUIERDO
		//Articulación 6---------------------------------------------
		model = glm::translate(model, glm::vec3(-1.7f, 2.5f, 1.2f));
		...
		model = glm::translate(model, glm::vec3(-0.13f, -0.15f, 1.0f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.7f, 3.5f, 0.7f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.5f, 0.5f, 0.5f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMesh();
		...
		//Articulación 7---------------------------------------------
		model = glm::translate(model, glm::vec3(-0.1f, -0.2f, 2.5f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion7()), glm::vec3(0.0f, 0.0f, 1.0f));
		modelaux = model;
		/*model = glm::scale(model, glm::vec3(0.5f, 0.5f, 0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		model = glm::translate(model, glm::vec3(-0.03f, 0.2f, 0.5f));
		model = glm::scale(model, glm::vec3(0.8f, 1.0f, 0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.7f, 0.7f, 0.7f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMesh();
		...
		//BRAZO DERECHO
		//Articulación 8---------------------------------------------
		model = glm::translate(model, glm::vec3(1.7f, 7.05f, -3.8f));
		...
		model = glm::translate(model, glm::vec3(0.1f, -0.15f, 1.0f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.7f, 3.5f, 0.7f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.5f, 0.5f, 0.5f);
		...
		//OJO IZQUIERDO
		model = glm::translate(model, glm::vec3(-0.9f, 0.4f, 2.0f));
		modelaux = model;
		model = glm::rotate(model, glm::radians(-90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		...
		//NARIZ
		model = glm::translate(model, glm::vec3(-1.0f, -0.8f, -0.5f));
		modelaux = model;
		model = glm::rotate(model, glm::radians(-96.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(1.0f, 1.0f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(1.0f, 0.7f, 0.8f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[1]->RenderMeshGeometry();
		model = modelaux;

		//BOCA
		model = glm::translate(model, glm::vec3(0.01f, -0.6f, 0.48f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(0.08f, 0.3f, 0.1f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 0.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMesh();
		...
		model = glm::translate(model, glm::vec3(0.01f, -0.19f, 0.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(1.0f, 0.08f, 0.1f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 0.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[0]->RenderMesh();
		...
		//OREJA IZQUIERDA
		model = glm::translate(model, glm::vec3(-1.8f, 2.8f, -1.5f));
		modelaux = model;
		...
		//OREJA DERECHA
		model = glm::translate(model, glm::vec3(3.38f, -0.1f, 0.0f));
		modelaux = model;
		model = glm::rotate(model, glm::radians(-30.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::scale(model, glm::vec3(3.0f, 5.0f, 3.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
