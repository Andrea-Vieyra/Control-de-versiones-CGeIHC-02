...
int main()
{
	...
	CuerpoHel = Model();
	CuerpoHel.LoadModel("Models/CuerpoHel.obj");
	Helices = Model();
	...
	while (!mainWindow.getShouldClose())
	{
		...
		glm::vec3 PosFaro = glm::vec3(0.0f, 14.0f, 9.5f + mainWindow.getmuevex());
		glm::vec3 direccionFaro = glm::vec3(0.0f, -1.0f, 0.0f);
		glm::vec3 lowerLight = PosFaro;
		lowerLight.y -= 0.3f;
		spotLights[0].SetFlash(lowerLight, direccionFaro);
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, 15.0f, 6.0));
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, mainWindow.getmuevex()));
		model = glm::scale(model, glm::vec3(0.2f, 0.2f, 0.2f));
		modelaux = model;
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		CuerpoHel.RenderModel();

		//Helices
		model = modelaux;
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, 4.3));
